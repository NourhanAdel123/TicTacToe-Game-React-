...
import xSound from "../Assets/x-sound.mp3";
import oSound from "../Assets/o-sound.wav";
...
function TicTacToe() {
  ...
  const xAudio = new Audio(xSound);
  const oAudio = new Audio(oSound);
  ...
  const toggle = (e, num) => {
    ...
    if (count % 2 === 0) {
      ...
      data[num] = "x";
      xAudio.play(); // Play X sound
      setCount(++count);
    } else {
      e.target.innerHTML = `<img src='${circle_icon}'>`;
      data[num] = "o";
      oAudio.play(); // Play O sound
      setCount(++count);
    }
    checkWin();
  };
